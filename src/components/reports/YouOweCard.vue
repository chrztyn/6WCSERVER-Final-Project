...
<template>
    <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 shadow-sm">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-2">You Owe</h2>
            <p class="text-sm text-gray-500 italic">A list of all the money you need to pay to other group members.</p>
        </div>
